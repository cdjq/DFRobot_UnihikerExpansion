...
eunihiker.set_mode(IONum.C0, IOType.GPIO_OUT)
eunihiker.set_mode(IONum.C1, IOType.GPIO_OUT)
eunihiker.set_mode(IONum.C2, IOType.GPIO_OUT)
eunihiker.set_mode(IONum.C3, IOType.GPIO_OUT)
eunihiker.set_mode(IONum.C4, IOType.GPIO_OUT)
eunihiker.set_mode(IONum.C5, IOType.GPIO_OUT)


while True:
    for pin in [IONum.C0, IONum.C1, IONum.C2, IONum.C3, IONum.C4, IONum.C5]:
         eunihiker.set_gpio_state(pin, GpioState.HIGH)
    for pin in [IONum.C0, IONum.C1, IONum.C2, IONum.C3, IONum.C4, IONum.C5]:
    ...
    for pin in [IONum.C0, IONum.C1, IONum.C2, IONum.C3, IONum.C4, IONum.C5]:     
         eunihiker.set_gpio_state(pin, GpioState.LOW)
    for pin in [IONum.C0, IONum.C1, IONum.C2, IONum.C3, IONum.C4, IONum.C5]:
        state = eunihiker.get_gpio_state(pin)
        print(f"{pin} state = {state}") 
    time.sleep(1)