...
def setup():
    ...
    exp.set_motor_period("MOTOR1_2", 60000)
    exp.set_motor_period("MOTOR3_4", 255)
    time.sleep(0.5)

def loop():   
    exp.set_motor_duty("MOTOR1_A", 30000)
    exp.set_motor_duty("MOTOR1_B", 0)
    exp.set_motor_duty("MOTOR2_A", 0)
    exp.set_motor_duty("MOTOR2_B", 10000)
    exp.set_motor_duty("MOTOR3_A", 20)
    exp.set_motor_duty("MOTOR3_B", 0)
    exp.set_motor_duty("MOTOR4_A", 0)
    exp.set_motor_duty("MOTOR4_B", 200)
    time.sleep(1)
    exp.set_motor_duty("MOTOR1_A", 300)
    exp.set_motor_duty("MOTOR1_B", 0)
    exp.set_motor_duty("MOTOR2_A", 0)
    exp.set_motor_duty("MOTOR2_B", 10)
    exp.set_motor_duty("MOTOR3_A", 200)
    exp.set_motor_duty("MOTOR3_B", 0)
    exp.set_motor_duty("MOTOR4_A", 0)
    exp.set_motor_duty("MOTOR4_B", 2)
    time.sleep(1)
